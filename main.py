...
if __name__ == '__main__':
    ...
    with open("zalando.data", "rb") as fid:
    ...
    model=U_Net(args.h, args.num_classes, args.scale)
    model = model.cuda()

    lrate=args.lr  
    optimizer_s = optim.SGD(model.parameters(), lr=lrate, momentum=0.6, weight_decay=1e-4)
